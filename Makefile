...
DLR=curl
DLR_FLAGS=-L
LNCR_ZIP_URL=https://github.com/sileshn/wsldl/releases/download/20201228/icons.zip
...
base.tar:
	...
	docker run --name soluswsl silkeh/solus:ypkg /bin/bash -c "eopkg up -y; eopkg it -y iptables openssh rsync; eopkg dc;"
